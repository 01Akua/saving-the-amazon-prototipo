...
export function FinalCta() {
  ...
  return (
    <section className="relative overflow-hidden mx-5 sm:mx-8 max-w-6xl lg:mx-auto rounded-3xl my-24">
      ...
      <motion.div
        className="relative px-8 py-20 text-center flex flex-col items-center"
        initial="hidden"
        whileInView="visible"
      ...
      >
        ...
        <motion.div variants={staggerItem} className="flex items-center gap-2 text-cream/60 text-xs mt-6">
          <ShieldCheck size={14} />
